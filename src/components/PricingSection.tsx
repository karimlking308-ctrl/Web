...
export const PricingSection: React.FC<PricingSectionProps> = ({
  ...
  const plans: {
    ...
    },
    {
      ...
      description: 'Instant access to ready-to-import Telegram Mini-Apps, WhatsApp AI bots, Solana sniper engines, and full digital vaults.',
      features: [
        'Telegram Mini-App & TON Clicker Game Boilerplate (React 19)',
        'WhatsApp AI Auto-Responder & Lead Gen System (Node + n8n)',
        'Solana Token Sniper & Launch Bot Kit (Jito MEV Bundles)',
        'Advanced n8n AI Agent Workflows (Content, Telegram, CRM)',
        'Solana Telegram Buy-Bot Source Code (Raydium / Pump.fun)',
        'Webhook & API Integration Boilerplates (Node.js & Python)',
        'All 1,500+ Curated AI & Web3 Prompt Vaults (JSON/MD)',
        'React 19 & Tailwind CSS SaaS Starter Codebase',
        'Solana Anchor 0.30 & Token-2022 smart contract kits',
      ],
    ...
    },
    {
      ...
      description: 'Perpetual master vault ownership: all 9 digital asset packages, source code, future tool drops, and commercial license forever.',
      features: [
        'Full perpetual access to all 9 current & future digital tools',
        'Telegram Mini-App + TON Connect Clicker Game source code',
        'WhatsApp AI Auto-Responder + Lead Generation microservice',
        'Solana Token Sniper & Pump.fun fast launch tracker engine',
        'All n8n AI Agent Workflows + Docker deployment stacks',
        'Solana Telegram Buy-Bot source code + WebSocket parsers',
        'Dual Node.js & Python Webhook backend engines',
        'Complete React 19 + Tailwind CSS SaaS codebase',
        'All 1,500+ curated prompt vaults & multi-agent directives',
