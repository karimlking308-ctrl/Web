...
export const PricingSection: React.FC<PricingSectionProps> = ({
  ...
  const plans: {
    ...
    },
    {
      ...
      description: 'Instant access to ready-to-import n8n AI agent workflows, webhook microservices, and complete digital vaults.',
      features: [
    ...
    },
    {
      ...
      description: 'Perpetual master vault ownership: all 6 digital asset packages, n8n automations, future tool drops, and source code forever.',
      features: [
