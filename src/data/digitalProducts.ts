...
export const DIGITAL_PRODUCTS: DigitalProduct[] = [
  ...
  {
    id: 'product-solana-bulk-sender',
    title: 'Solana Bulk Token Sender & Airdrop Script',
    category: 'web3',
    tagline: 'High-Throughput Multi-Wallet Token Distribution & CSV Airdrop CLI in Python',
    version: 'v2.4.0 (Python 3.11+ Solders)',
    fileSize: '4.2 MB (Full Script Package)',
    formats: ['Python 3.11+', 'Solders SDK', 'Solana-Py Async', 'Rich CLI Terminal', 'CSV / JSON'],
    badge: '⚡ Airdrop Engine · Python CLI',
    tierRequired: 'all_paid',
    description:
    ...
    includedFiles: [
      {
        ...
        size: '24 KB',
        description: 'Main asynchronous multi-wallet distribution engine with Rich progress dashboard.',
      },
      {
        name: 'recipients.sample.csv',
        type: 'CSV Data Template',
        size: '2 KB',
        description: 'Formatted CSV template with validation rules for mass airdrop execution.',
      },
      {
        name: 'requirements.txt',
        type: 'Python Dependencies',
        size: '1 KB',
        description: 'Pinned dependencies for Solders, Solana-Py, Rich CLI, and Pydantic.',
      },
      {
        name: 'README_AIRDROP.md',
        type: 'Setup Manual',
        size: '18 KB',
        description: 'Comprehensive guide for ATA rent optimization, priority fees, and Jito tips.',
      },
    ],
  },
  {
    id: 'product-telegram-broadcast-bot',
    title: 'Telegram Broadcast & Member Management Bot Script',
    category: 'dev',
    tagline: 'High-Concurrency Telegram Message Broadcast & Automated Community Guard in Node.js',
    version: 'v3.1.0 (Grammy 1.30+ & Node.js 22)',
    fileSize: '5.6 MB (Full Script Package)',
    formats: ['Node.js 22', 'TypeScript', 'Grammy.js', 'SQLite / Postgres', 'HTML Parser'],
    ...
    includedFiles: [
      {
        ...
        size: '32 KB',
        description: 'High-throughput rate-limited broadcast dispatcher engine with retry handling.',
      },
      {
        name: 'guard.ts',
        type: 'TypeScript Daemon',
        size: '28 KB',
        description: 'Automated 24/7 group moderation, math captcha challenge, and link cleaner.',
      },
      {
        name: 'package.json',
        type: 'Node.js Manifest',
        size: '2 KB',
        description: 'Preconfigured build scripts, Grammy dependencies, and TypeScript setup.',
      },
    ],
  },
  {
    id: 'product-ai-content-batch-generator',
    title: 'AI Content Batch Generator Script',
    category: 'ai',
    tagline: 'Automated Markdown Article, SEO Metadata & Social Copy Bulk Synthesizer in Python',
    version: 'v2.8.0 (Gemini 2.5 Flash + Pydantic)',
    fileSize: '3.8 MB (Full Script Package)',
    formats: ['Python 3.11+', 'Google GenAI SDK', 'Pydantic V2', 'YAML Frontmatter', 'Markdown'],
    ...
    includedFiles: [
      {
        name: 'batch_generator.py',
        type: 'Python Automation Script',
        size: '26 KB',
        description: 'Async Gemini-powered content generator with Pydantic JSON validation.',
      },
      {
        name: 'topics.sample.csv',
        type: 'CSV Keyword Matrix',
        size: '2 KB',
        description: 'Sample CSV containing 25 high-traffic Web3 and SaaS keyword pillars.',
      },
      {
        name: 'schema_validator.py',
        type: 'Pydantic Schemas',
        size: '14 KB',
        description: 'Strict typing schemas for SEO metadata, Twitter threads, and frontmatter.',
      },
    ],
  },
];
